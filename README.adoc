...
`cURL` or `HTTPie`.
* In your IDE if you are using STS, IntelliJ IDEA Ultimate, Intelij IDEA Community (with
https://plugins.jetbrains.com/plugin/23564-spring-initializr[this plugin]), NetBeans (with

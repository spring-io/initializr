...
.request
include::{snippets}/get/ROOT/headers/Accept-application_vnd.initializr.v2+json/http-request.adoc[]

.response
include::{snippets}/get/ROOT/headers/Accept-application_vnd.initializr.v2+json/http-response.adoc[]

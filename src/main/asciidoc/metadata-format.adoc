...
include::{snippets}/metadataWithV2AcceptHeader/response-fields/dependencies.values.adoc[]
...
.type.values[0]
include::{snippets}/metadataWithV2AcceptHeader/response-fields/type.values.adoc[]
...
.packaging.values[0]
include::{snippets}/metadataWithV2AcceptHeader/response-fields/packaging.values.adoc[]
...
include::{snippets}/metadataWithV2AcceptHeader/response-fields/javaVersion.values.adoc[]
...
.language.values[0]
include::{snippets}/metadataWithV2AcceptHeader/response-fields/language.values.adoc[]
...
include::{snippets}/metadataWithV2AcceptHeader/response-fields/bootVersion.values.adoc[]

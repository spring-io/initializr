...
class RequestedDependenciesHelpDocumentCustomizerTests {
    ...
    void dependencyWithReferenceDocLinkUseDefaultPlatformVersionIfNoneIsSet() {
        Dependency dependency = createDependency("example", Link.create("reference", "https://example.com/{bootVersion}/doc", "Reference doc example"));
        ...
        assertSingleLink(document.gettingStarted().referenceDocs(), "https://example.com/2.4.1/doc", "Reference doc example");
    }
    ...
    void dependencyWithReferenceDocLinkUsePlatformVersion() {
        ...
        assertThat(document.gettingStarted().isEmpty()).isFalse();
        assertSingleLink(document.gettingStarted().referenceDocs(), "https://example.com/2.4.10/doc", "Reference doc example");
    }
    ...
    void dependencyWithSeveralReferenceDocLinksDoNotGetDependencyNameByDefault() {
        Dependency dependency = createDependency("example", Link.create("reference", "https://example.com/doc"), Link.create("reference", "https://example.com/doc2"));
        dependency.setName("Example Library");
        this.metadataBuilder.addDependencyGroup("test", dependency);
        HelpDocument document = customizeHelp("example");
    ...
    void dependencyWithGuideLinkUseDefaultPlatformVersionIfNoneIsSet() {
        Dependency dependency = createDependency("example", Link.create("guide", "https://example.com/{bootVersion}/how-to", "How-to example"));
        this.metadataBuilder.addDependencyGroup("test", dependency);
        HelpDocument document = customizeHelp("example");
        assertThat(document.gettingStarted().isEmpty()).isFalse();
    ...
    void dependencyWithSeveralGuideLinksDoNotGetDependencyNameByDefault() {
        Dependency dependency = createDependency("example", Link.create("guide", "https://example.com/how-to"), Link.create("guide", "https://example.com/anothero"));
        dependency.setName("Example Library");
        this.metadataBuilder.addDependencyGroup("test", dependency);
        HelpDocument document = customizeHelp("example");
        assertThat(document.gettingStarted().isEmpty()).isTrue();
    ...
    void dependencyWithAdditionalLinkUseDefaultPlatformVersionIfNoneIsSet() {
        Dependency dependency = createDependency("example", Link.create("something", "https://example.com/{bootVersion}/test", "Test App"));
        this.metadataBuilder.addDependencyGroup("test", dependency);
        HelpDocument document = customizeHelp("example");
        assertThat(document.gettingStarted().isEmpty()).isFalse();

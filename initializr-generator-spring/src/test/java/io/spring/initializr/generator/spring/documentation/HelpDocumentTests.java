...
class HelpDocumentTests {
    ...
    void renderWarnings() {
        ...
        String out = write(document);
        assertThat(out).contains("# Read Me First", "The following was discovered as part of building this project:", "", "* Invalid groupId '#invalid#'", "* Invalid package name '#invalid#'");
    }
    ...
    void renderLinks() {
        ...
        String out = write(document);
        assertThat(out).contains("# Getting Started", "", "### Reference Documentation", "For further reference, please consider the following sections:", "", "* [Doc](https://example.com/doc)", "", "### Guides", "The following guides illustrate how to use some features concretely:", "", "* [Guide 1](https://example.com/guide-1)", "* [Guide 2](https://example.com/guide-2)", "");
    }
    ...
    void renderOnlyAdditionalLink() {
        ...
        String out = write(document);
        assertThat(out).contains("# Getting Started", "", "### Additional Links", "These additional references should also help you:", "", "* [Test App](https://example.com/app)", "");
    }

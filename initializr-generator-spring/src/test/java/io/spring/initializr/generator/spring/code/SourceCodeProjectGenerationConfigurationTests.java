...
class SourceCodeProjectGenerationConfigurationTests {
    ...
    private final ProjectAssetTester projectTester = new ProjectAssetTester().withConfiguration(SourceCodeProjectGenerationConfiguration.class);
    ...
    void addsACustomizerThatAppliesSpringBootApplicationAnnotationOnMainClass() {
        ...
        assertThat(declaration.getAnnotations()).singleElement().satisfies((annotation) -> assertThat(annotation.getName()).isEqualTo("org.springframework.boot.autoconfigure.SpringBootApplication"));
    }
    ...
    void addsACustomizerThatAppliesTestAnnotationsOnTestClassWithJunit5() {
        ...
        assertThat(declaration.getAnnotations()).hasSize(1);
        assertThat(declaration.getAnnotations().get(0).getName()).isEqualTo("org.springframework.boot.test.context.SpringBootTest");
    }

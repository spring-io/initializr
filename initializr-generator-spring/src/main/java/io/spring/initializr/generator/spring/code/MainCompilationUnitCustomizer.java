...
/**
 * Callback for customizing the application's main compilation unit. Invoked with an
 ...
 */
@FunctionalInterface
public interface MainCompilationUnitCustomizer<T extends TypeDeclaration, C extends CompilationUnit<T>> extends Ordered {

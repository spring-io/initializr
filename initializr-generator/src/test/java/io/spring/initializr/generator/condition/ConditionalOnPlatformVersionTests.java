...
class ConditionalOnPlatformVersionTests {
    ...
    void outcomeWithSeveralRangesAndMatchingVersion() {
        ...
        assertThat(candidatesFor(description, PlatformVersionTestConfiguration.class, OneOrTwoPlatformVersionTestConfiguration.class)).containsOnlyKeys("second", "firstOrSecond");
    }
    ...
    void outcomeWithSeveralRangesAndNonMatchingVersion() {
        ...
        assertThat(candidatesFor(description, PlatformVersionTestConfiguration.class, OneOrTwoPlatformVersionTestConfiguration.class)).containsOnlyKeys("second");
    }

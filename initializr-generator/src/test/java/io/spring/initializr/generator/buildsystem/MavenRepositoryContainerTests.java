...
class MavenRepositoryContainerTests {
    ...
    void addMavenRepositoryInstance() {
        MavenRepositoryContainer container = createTestContainer();
        MavenRepository instance = MavenRepository.withIdAndUrl("test", "https://example.com/releases").name("my repo").build();
    ...
    void addMavenRepositoryWithSnapshotsEnabled() {
        MavenRepositoryContainer container = createTestContainer();
        container.add(MavenRepository.withIdAndUrl("custom", "https://example.com/snapshots").name("custom-snapshots").onlySnapshots());

...
public class MavenProfileActivationTests {
    ...
    void profileActiveByDefaultCanBeAmended() {
        assertThat(createProfileActivation().activeByDefault(true).activeByDefault(null).build().getActiveByDefault()).isNull();
    }
    ...
    void profileActivationOsCanBeDisabled() {
        assertThat(createProfileActivation().os("test-name", null, null, null).os(null, null, null, null).build().getOs()).isNull();
    }
